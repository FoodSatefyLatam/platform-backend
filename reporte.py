            ...
            for consumo in res:
                ...
                for contaminante in contaminantes:
                    ...
                    if not contaminante["nombre"] in avg_contaminantes:
                        avg_contaminantes[contaminante["nombre"]] = (alimento[0][contaminante["nombre"]] * consumo[2])/(30*10000000)
                    else:
                        avg_contaminantes[contaminante["nombre"]] += (alimento[0][contaminante["nombre"]] * consumo[2])/(30*1000000)
