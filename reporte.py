...
def reporte():
    ...
    for contaminante in contaminantes:
        cur.execute("SELECT * FROM persona FULL OUTER JOIN consumo ON persona.id_folio=consumo.id_folio FULL OUTER JOIN muestreo ON persona.id_region=muestreo.id_region FULL OUTER JOIN contaminante ON contaminante.id_contaminante=muestreo.id_contaminante WHERE contaminante.nombre = %s",[contaminante])
